...
import {DefaultLayuout, ExoticLayout, MainLayuout, WalletLayout} from "./layouts";
...
export default function App() {
    return (
                <Routes>
                    <Route path="/" element={<MainLayuout/>}>
                        <Route index element={<UnloginOnly><MainPage/></UnloginOnly>}/>
                    </Route>
                    <Route path="/" element={<DefaultLayuout/>}>
                        <Route path="login" element={<UnloginOnly><LoginPage/></UnloginOnly>}/>
